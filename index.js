...
function optionsFromArguments(args) {
    ...
    options = fromEnvironmentOrDefault(options, 'quality_auto', 'QUALITY_AUTO', true);
    return options;
}
...
Cloudinary.prototype.getFileLocation = function (config, filename) {
    ...
    return ("https://res.cloudinary.com/" + this.cloudinary_config.cloud_name + "/" + this.getResourceType(filename) + "/upload/" + (quality_auto ? "q_auto/" : "") + encodeURIComponent(filename));
}
